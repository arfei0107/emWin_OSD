...
extern int usnprintf(char * __restrict s, size_t n, const char * __restrict format, ...);
extern int usprintf(char * __restrict s, const char * __restrict format, ...);
...
extern char *ustrncpy(char * __restrict s1, const char * __restrict s2, size_t n);
extern char *ustrstr(const char *s1, const char *s2);
extern float ustrtof(const char * __restrict nptr,
                     const char ** __restrict endptr);
extern unsigned long int ustrtoul(const char * __restrict nptr,
                                  const char ** __restrict endptr, int base);
extern int uvsnprintf(char * __restrict s, size_t n,
