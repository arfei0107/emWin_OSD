...
//*****************************************************************************
char *
ustrncpy(char * __restrict s1, const char * __restrict s2, size_t n)
{
    size_t count;
...
//*****************************************************************************
int
uvsnprintf(char * __restrict s, size_t n, const char * __restrict format,
           va_list arg)
{
...
//
//*****************************************************************************
int usprintf(char * __restrict s, const char *format, ...)
{
    va_list arg;
    int ret;
...
//
//*****************************************************************************
int usnprintf(char * __restrict s, size_t n, const char * __restrict format, ...)
{
    va_list arg;
    int ret;
...
//
//*****************************************************************************
unsigned long ustrtoul(const char * __restrict nptr, const char ** __restrict endptr, int base)
{
    ...
    if( (!nptr) || (!((base == 0) || ((base > 1) && (base <= 16)))) ) return 0;
