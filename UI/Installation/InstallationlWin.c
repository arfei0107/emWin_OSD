...
**********************************************************************
*/
static xDROPDOWN_ITEM aInstallation_Style_Items[] = 
{
    {"Front"              ,xDROPDOWN_ITEM_ENABLE},
    {"Celling Mount(F)"   ,xDROPDOWN_ITEM_ENABLE},
    {"Rear"               ,xDROPDOWN_ITEM_ENABLE},
    {"Celling Mount(R)"   ,xDROPDOWN_ITEM_ENABLE},
};

static xDROPDOWN_ITEM aAnamorphic_Items[] = 
{
...
static xDROPDOWN_ITEM aScreen_Adjust_Items[] = 
{
    {"Off"                ,xDROPDOWN_ITEM_ENABLE},
    {"A"                  ,xDROPDOWN_ITEM_ENABLE},
    {"B"                  ,xDROPDOWN_ITEM_ENABLE},
...
static xDROPDOWN_Obj wInstallation_Stype = 
{
    xDROPDOWN_ENABLE,                                              //eDROPDOWN_STATE      State;                                                            
    aInstallation_Style_Items,                                     //xDROPDOWN_ITEM      *paDropDownItems;                                              
    GUI_COUNTOF(aInstallation_Style_Items),                        //int                  NumItems;                                                     
...
static xDROPDOWN_Obj wAnamorphic = 
{
    xDROPDOWN_ENABLE,                                              //eDROPDOWN_STATE      State;                                                            
    aAnamorphic_Items,                                             //xDROPDOWN_ITEM      *paDropDownItems;                                              
    GUI_COUNTOF(aAnamorphic_Items),                                //int                  NumItems;                                                     
    &bmbt_w190_h26_a,                                              //GUI_BITMAP*          pBtnBmp
    GUI_UI_COLOR8,
    {GUI_UI_COLOR3,GUI_UI_COLOR4,GUI_UI_COLOR4,GUI_UI_COLOR4},     //GUI_COLOR            BarTextColor[4];                                              
    &GUI_FontHGPGothicB19,                                         //const GUI_FONT      *pBarTextFont;
...
static xDROPDOWN_Obj wScreen_Adjust = 
{
    xDROPDOWN_ENABLE,                                              //eDROPDOWN_STATE      State;                                                            
    aScreen_Adjust_Items,                                          //xDROPDOWN_ITEM      *paDropDownItems;                                              
    GUI_COUNTOF(aScreen_Adjust_Items),                             //int                  NumItems;                                                     
    &bmbt_w190_h26_a,                                              //GUI_BITMAP*          pBtnBmp
    GUI_UI_COLOR8,
    {GUI_UI_COLOR3,GUI_UI_COLOR4,GUI_UI_COLOR4,GUI_UI_COLOR4},     //GUI_COLOR            BarTextColor[4];                                              
    &GUI_FontHGPGothicB19,                                         //const GUI_FONT      *pBarTextFont;
...
{
    (xDROPDOWN_Obj*)&wInstallation_Stype,
    (xDROPDOWN_Obj*)&wAnamorphic,
    (xDROPDOWN_Obj*)&wScreen_Adjust,
};
...
static const GUI_WIDGET_CREATE_INFO _DialogButton4[] ={
  ...
  { SLIDER_CreateIndirect,    NULL, ID_SLIDER4,    248,   5, 190,  26,  0, 0x0, sizeof(xSLIDER_Obj) },
  { IMAGE_CreateIndirect,     NULL, ID_IMAGE4,     192,   5,  44,  26,  WM_CF_SHOW },
  { TEXT_CreateIndirect,       "50",ID_TEXT4,      192,   5,  44,  26,  TEXT_CF_HCENTER | TEXT_CF_VCENTER},
};
...
**********************************************************************
*/
WM_HWIN InstallationWin_Init(WM_HWIN hMultiPage)
{
    WM_HWIN hDialog;
    WM_HWIN hItem;
    int i, Id;
    ...
    MULTIPAGE_AddPage(hMultiPage, hDialog, "Installation");
    DEBUGOUT("InstallationWin_Init(): MULTIPAGE_AddPage(): hDialog:0x%08x\r\n", hDialog);
