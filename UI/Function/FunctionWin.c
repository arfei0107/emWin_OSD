...
**********************************************************************
*/
static xDROPDOWN_ITEM aTrigger_Items[] = 
{
    {"Off"                ,xDROPDOWN_ITEM_ENABLE},
    {"On(Power)"          ,xDROPDOWN_ITEM_ENABLE},
    {"On(Anamo)"          ,xDROPDOWN_ITEM_ENABLE},
};

static xDROPDOWN_ITEM aOff_Timer_Items[] = 
{
    {"Off"                ,xDROPDOWN_ITEM_ENABLE},
    {"1 Hour"             ,xDROPDOWN_ITEM_ENABLE},
    {"2 Hours"            ,xDROPDOWN_ITEM_ENABLE},
    {"3 Hours"            ,xDROPDOWN_ITEM_ENABLE},
    {"4 Hours"            ,xDROPDOWN_ITEM_ENABLE},
};
static xDROPDOWN_ITEM aHigh_Altitude_Mode_Items[] = 
{
    {"On"                 ,xDROPDOWN_ITEM_ENABLE},
    {"Off"                ,xDROPDOWN_ITEM_ENABLE},
};
static xDROPDOWN_ITEM aECO_Mode_Items[] = 
{
    {"On"                 ,xDROPDOWN_ITEM_ENABLE},
    {"Off"                ,xDROPDOWN_ITEM_ENABLE},
};

static xDROPDOWN_ITEM aComm_Ternimal_Items[] = 
{
    {"RS-232C"            ,xDROPDOWN_ITEM_ENABLE},
    {"LAN"                ,xDROPDOWN_ITEM_ENABLE},
};
static xDROPDOWN_ITEM aRemote_Code_Items[] = 
{
    {"A"                  ,xDROPDOWN_ITEM_ENABLE},
    {"B"                  ,xDROPDOWN_ITEM_ENABLE},
};

static xDROPDOWN_Obj wTrigger= 
{
    xDROPDOWN_ENABLE,                                              //eDROPDOWN_STATE      State;                                                            
    aTrigger_Items,                                                //xDROPDOWN_ITEM      *paDropDownItems;                                              
    GUI_COUNTOF(aTrigger_Items),                                   //int                  NumItems;                                                     
...
static xDROPDOWN_Obj wOff_Timer= 
{
    xDROPDOWN_ENABLE,                                              //eDROPDOWN_STATE      State;                                                            
    aOff_Timer_Items,                                              //xDROPDOWN_ITEM      *paDropDownItems;                                              
    GUI_COUNTOF(aOff_Timer_Items),                                 //int                  NumItems;                                                     
    &bmbt_w190_h26_a,                                              //GUI_BITMAP*          pBtnBmp
    GUI_UI_COLOR8,
    {GUI_UI_COLOR3,GUI_UI_COLOR4,GUI_UI_COLOR4,GUI_UI_COLOR4},     //GUI_COLOR            BarTextColor[4];                                              
    &GUI_FontHGPGothicB19,                                         //const GUI_FONT      *pBarTextFont;
...
static xDROPDOWN_Obj wHigh_Altitude_Mode= 
{
    xDROPDOWN_ENABLE,                                              //eDROPDOWN_STATE      State;                                                            
    aHigh_Altitude_Mode_Items,                                     //xDROPDOWN_ITEM      *paDropDownItems;                                              
    GUI_COUNTOF(aHigh_Altitude_Mode_Items),                        //int                  NumItems;                                                     
    &bmbt_w190_h26_a,                                              //GUI_BITMAP*          pBtnBmp
    GUI_UI_COLOR8,
    {GUI_UI_COLOR3,GUI_UI_COLOR4,GUI_UI_COLOR4,GUI_UI_COLOR4},     //GUI_COLOR            BarTextColor[4];                                              
    &GUI_FontHGPGothicB19,                                         //const GUI_FONT      *pBarTextFont;
...
static xDROPDOWN_Obj wECO_Mode= 
{
    xDROPDOWN_ENABLE,                                              //eDROPDOWN_STATE      State;                                                            
    aECO_Mode_Items,                                               //xDROPDOWN_ITEM      *paDropDownItems;                                              
    GUI_COUNTOF(aECO_Mode_Items),                                  //int                  NumItems;                                                     
    &bmbt_w190_h26_a,                                              //GUI_BITMAP*          pBtnBmp
    GUI_UI_COLOR8,
    {GUI_UI_COLOR3,GUI_UI_COLOR4,GUI_UI_COLOR4,GUI_UI_COLOR4},     //GUI_COLOR            BarTextColor[4];                                              
    &GUI_FontHGPGothicB19,                                         //const GUI_FONT      *pBarTextFont;
...
static xDROPDOWN_Obj wComm_Ternimal= 
{
    xDROPDOWN_ENABLE,                                              //eDROPDOWN_STATE      State;                                                            
    aComm_Ternimal_Items,                                          //xDROPDOWN_ITEM      *paDropDownItems;                                              
    GUI_COUNTOF(aComm_Ternimal_Items),                             //int                  NumItems;                                                     
    &bmbt_w190_h26_a,                                              //GUI_BITMAP*          pBtnBmp
    GUI_UI_COLOR8,
    {GUI_UI_COLOR3,GUI_UI_COLOR4,GUI_UI_COLOR4,GUI_UI_COLOR4},     //GUI_COLOR            BarTextColor[4];                                              
    &GUI_FontHGPGothicB19,                                         //const GUI_FONT      *pBarTextFont;
...
static xDROPDOWN_Obj wRemote_Code= 
{
    xDROPDOWN_ENABLE,                                              //eDROPDOWN_STATE      State;                                                            
    aRemote_Code_Items,                                            //xDROPDOWN_ITEM      *paDropDownItems;                                              
    GUI_COUNTOF(aRemote_Code_Items),                               //int                  NumItems;                                                     
    &bmbt_w190_h26_a,                                              //GUI_BITMAP*          pBtnBmp
    GUI_UI_COLOR8,
    {GUI_UI_COLOR3,GUI_UI_COLOR4,GUI_UI_COLOR4,GUI_UI_COLOR4},     //GUI_COLOR            BarTextColor[4];                                              
...
{
    (xDROPDOWN_Obj*)&wTrigger,
    (xDROPDOWN_Obj*)&wOff_Timer,
    (xDROPDOWN_Obj*)&wHigh_Altitude_Mode,
    (xDROPDOWN_Obj*)&wECO_Mode,
    (xDROPDOWN_Obj*)&wComm_Ternimal,
    (xDROPDOWN_Obj*)&wRemote_Code,
};
...
static const GUI_WIDGET_CREATE_INFO _DialogButton7[] ={
  { xBUTTON_CreateIndirect,   NULL, ID_BTN7,        12, 261, 470,  36,  0, (I32)&xBUTTON7},
};
...
**********************************************************************
*/
WM_HWIN FunctionWin_Init(WM_HWIN hMultiPage)
{
    WM_HWIN hDialog;
    WM_HWIN hItem;
    int i, Id;
    ...
    MULTIPAGE_AddPage(hMultiPage, hDialog, "Function");
    DEBUGOUT("FunctionWin_Init(): MULTIPAGE_AddPage(): hDialog:0x%08x\r\n", hDialog);
