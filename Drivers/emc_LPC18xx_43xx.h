/***********************************************************************
 * $Id:   emc_LPC18xx_43xx.h
 *
 * Project: NXP LPC4300 LCD example
 *
 * Description:  Header file for emc_LPC43xx.c
 *
...
#ifndef EMC_LPC18XX_43XX_H_
#define EMC_LPC18XX_43XX_H_
...
enum {
	...
	#define SDRAM_SIZE               0x02000000 	// 32 MByte SDRAM EM63A165TS-6G
	#define SDRAM_BASE               0x28000000		// base address for DYCS0

	// We have 16 data lines connected to the SDRAM
	#define PART_WIDTH (PART_WIDTH_16)		// part width (possibly smaller than EXT_WIDTH, e.g. two 8-bit chips cascaded as 16-bit memory.
	#define PART_SIZE (PART_SIZE_256)
	#define EXT_WIDTH (EXT_WIDTH_16) 		// external memory bus width
	#define COL_ADDR_BITS (9) 				// for calculating how to write mode bits
#endif

#if defined NXP_EVAL_BOARD
...
#if defined NXP_VALIDATION_BOARD     // the NXP validation board	
	#define SDRAM_SIZE               0x01000000 	// 16 MByte SDRAM MT48LC4M32
	#define SDRAM_BASE               0x28000000		// base address for DYCS0
